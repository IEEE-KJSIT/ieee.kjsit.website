...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-start justify-center overflow-hidden bg-gradient-to-br from-[#000428] to-[#004e92] text-white px-4 pt-6 md:pt-0">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-20">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 md:mb-6 text-balance leading-tight">
        ...
        <p className="text-lg md:text-xl text-blue-100/90 mb-6 md:mb-8 max-w-2xl mx-auto text-pretty leading-relaxed animate-fade-up">
