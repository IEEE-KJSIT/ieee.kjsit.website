...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#000428] to-[#004e92] text-white px-4">
      <div id="particles-js" className="absolute inset-0 z-10"></div>

      <div className="max-w-4xl mx-auto text-center relative z-20">
        <div className="inline-block bg-white/10 backdrop-blur-sm border border-white/20 px-4 py-2 rounded-full text-sm font-semibold mb-6 text-[#FFD700] tracking-wider animate-fade-down">
          IEEE KJSIT 2025-26
        </div>
        ...
        <p className="text-lg md:text-xl text-blue-100/90 mb-8 max-w-2xl mx-auto text-pretty leading-relaxed animate-fade-up">
